...
$(document).ready(function() {
    ...
    function postAction(action, data, callback) {
        ...
        $.post(window.APP_URL + '/index.php', postData, callback || function(r) {
            ...
            console.error('Errore di comunicazione con il server per l\'azione:', action, jqXHR.responseText);
    ...
    function saveColumnWidths() {
        ...
        // L'originale salvava via POST, ma localStorage è più efficiente e non richiede un round-trip
        postAction('save_column_widths', { column_widths: w }, () => {}); // No reload
    }
        ...
        postAction('save_concessione_edit', { original_idf24: editOriginalData.idf24, updates: JSON.stringify(updates) }, function(r) {
            if (r.success) {
                ...
                if (keepOpen) {
                    ...
                    window.location.href = window.location.href; // Ricarica per vedere i cambiamenti
                }
            } else {
