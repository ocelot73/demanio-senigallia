...
/**
 * @var pgsql|false|null Mantiene una singola istanza della connessione al database (Singleton).
 */
 ...
 *
 * @return pgsql|false Il resource della connessione al database in caso di successo.
...
function get_db_connection() {
    ...
    // Se esiste già una connessione attiva, la restituisce immediatamente.
    ...
    try {
        ...
        // Imposta lo schema di default per tutte le query su questa connessione.
        pg_query($db_connection_instance, "SET search_path TO " . pg_escape_string($db_connection_instance, DB_SCHEMA));
        ...
        // In un'app complessa, si potrebbe renderizzare una pagina di errore dedicata.
 ...
 *
 * @param pgsql|false $conn La risorsa della connessione al database (ottenuta da get_db_connection()).
